...
const SignUp = ({ data, setData, otpSent, setOtpSent, otpVerified, setOtpVerified, otp, setOtp, error, setError, handleOtpChange, handleSignIn, validateEmail, sendOtp, verifyOtp, getButton, firstOtpFails, otpFailsMoreThanOne }) => {
  return (
    <>
      <h5 className="d-flex justify-content-center fs-3 pb-3">
        Welcome to Rock_bishop <FaChessKing className="fs-1 pb-1 fc-b" />
      </h5>
      ...
      <Button onClick={handleSignIn} disabled={!otpVerified}>Sign Up</Button>
    </>
  );
};
