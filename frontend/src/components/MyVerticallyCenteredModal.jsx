...
function MyVerticallyCenteredModal({ show, onHide, setLogin }) {
  ...
  const login = async (email, password) => {
    const response = await fetch("http://rock-bishop-auth.onrender.com/api/auth/login", {
      method: "POST",
      headers: {
  ...
  const signIn = async (username, email, password) => {
    const response = await fetch("http://rock-bishop-auth.onrender.com/api/auth/signin", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
